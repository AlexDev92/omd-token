...
!(function (t, e) {
  ...
  else if ("undefined" != typeof exports) e(exports, require("jQuery"));
  else {
    var i = { exports: {} };
    e(i.exports, t.jQuery), (t.jqueryAsPieProgress = i.exports);
  }
})(this, function (t, e) {
  "use strict";
  function i(t) {
  ...
  for (
    ...
    (window.requestAnimationFrame = window[m + "RequestAnimationFrame"]),
      (window.cancelAnimationFrame =
        window[m + "CancelAnimationFrame"] ||
        window[m + "CancelRequestAnimationFrame"]);
  }
  (!/iP(ad|hone|od).*OS (6|7)/.test(window.navigator.userAgent) &&
  ...
  var p = "createElementNS" in document && new u("svg", {}).createSVGRect,
    g = "asPieProgress";
  f.namespace = g;
  var v = (function () {
    function t(e, i) {
      n(this, t),
        (this.element = e),
        (this.$element = (0, s.default)(e)),
        (this.options = s.default.extend({}, f, i, this.$element.data())),
        (this.namespace = this.options.namespace),
        (this.classes = this.options.classes),
        (this.easing = t.easing[this.options.easing] || t.easing.ease),
        ...
        [
          ...
          },
          {
            ...
            value: function () {
              p &&
                ...
                this.buildTrack(),
                this.buildBar(),
                (0, s.default)('<div class="' + this.classes.svg + '"></div>')
                  .append(this.svg)
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var r = "on" + t;
              "function" == typeof this.options[r] && this.options[r](i);
            },
          },
          {
            key: "getPercentage",
          ...
          },
          {
            key: "destory",
            value: function () {
              this.$element.data(g, null), this._trigger("destory");
            },
          },
        ],
        [
          {
            ...
            value: function (e) {
              ...
              if ("string" == typeof e) {
                var u = (function () {
                  var t = e;
                  if (/^\_/.test(t)) return { v: !1 };
                  if (!/^(get)$/.test(t))
                    return {
                      v: i.each(function () {
                        var e = s.default.data(this, g);
                        e && "function" == typeof e[t] && e[t].apply(e, a);
                      }),
                    };
                  var n = i.first().data(g);
                  return n && "function" == typeof n[t]
                    ? { v: n[t].apply(n, a) }
                    : void 0;
                })();
                if ("object" === ("undefined" == typeof u ? "undefined" : r(u)))
                  return u.v;
              }
              return this.each(function () {
                s.default.data(this, g) ||
                  s.default.data(this, g, new t(this, e));
              });
            },
          },
        ]
  ...
  s.default.extend((v.easing = {}), {
    ...
    (s.default.fn[g] = v._jQueryInterface),
    (s.default.fn[g].constructor = v),
    (s.default.fn[g].noConflict = function () {
      return (s.default.fn[g] = window.JQUERY_NO_CONFLICT), v._jQueryInterface;
    }),
    (t.default = v);
});
...
function initCircleProgress(card) {
  ...
  $(card).find(".svg-gradient > *").attr("id", $ID);
  $(card).find("svg linearGradient").attr("id", $ID);
  $(card)
    .find(".pie_progress svg path")
    .each(function () {
